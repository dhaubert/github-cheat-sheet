...
Uma lista completa de funcionalidades escondidas e nem tão escondidas sobre Git e Github. Esse cheat sheet foi inspirado por [Zach Holman](https://github.com/holman)'s [Git and GitHub Secrets](http://confreaks.tv/videos/aloharuby2012-git-and-github-secrets) em sua palestra na Aloha Ruby Conference 2012 ([slides](https://speakerdeck.com/holman/git-and-github-secrets)) e sua palestra [More Git and GitHub Secrets](https://vimeo.com/72955426) na WDCNZ 2013 ([slides](https://speakerdeck.com/holman/more-git-and-github-secrets)).

*Link encurtado: [`http://git.io/sheet`](http://git.io/sheet)*

*Leia isso em outros idiomas: [English](README.md), [한국어](README.ko.md), [日本語](README.ja.md), [简体中文](README.zh-cn.md), [正體中文](README.zh-tw.md), [Português (Brasil)](README.pt-BR.md).*

## Índice
  - [GitHub](#github)
    - [Ignorar espaços em branco](#ignorar-espaços-em-branco)
    - [Ajustar espaçamento de tabelas](#ajustar-espaçamento-de-tabelas)
    - [Histório de commits por autor](#histórico-de-commits-por-autor)
    - [Clonando um repositório](#clonando-um-repositório)
    - [Branch](#branch)
      - [Compare todas as branches com outra branch](#compare-todas-as-branches-com-outra-branch)
      - [Comparando Branches](#comparando-branches)
      - [Comparando Branches através de Repositórios Bifurcados](#comparando-branches-através-de-repositórios-bifurcados)
    - [Gists](#gists)
    - [Git.io](#gitio)
    - [Atalhos de teclado](#atalhos-de-teclado)
    - [Destaque para Linha em Repositórios](#destaque-para-linha-em-repositórios)
    - [Fechando Issues pelas Mensagens de Commit](#fechando-issues-pelas-mensagens-de-commit)
    - [Referências cruzadas em Issues](#referências-cruzadas-em-issues)
    - [Bloqueando Conversas](#bloqueando-conversas)
    - [CI Status em Pull Requests](#ci-status-em-pull-requests)
    - [Filtros](#filtros)
    - [Destaque de Sintaxe em Arquivos Markdown](#destaque-de-sintaxe-em-arquivos-markdown)
    - [Emojis](#emojis)
    - [Imagens/GIFs](#imagensgifs)
      - [Imagens embutidas na Wiki do GitHub](#imagens-embutidas-na-wiki-do-github)
    - [Citações Rápidas](#citações-rápidas)
    - [Colando imagens da Área de Transferência para comentários](#colando-imagens-da-área-de-transferência-para-comentários)
    - [Licensa Rápida](#lcensa-rápida)
    - [Listas de tarefas](#listas-de-tarefas)
      - [Listas de Tarefas em Documentos Markdown](#listas-de-tarefas-em-documentos-markdown)
    - [Links Relativos](#links-relativos)
    - [Metadados e Suporte a Plugins para Páginas do GitHub](#metadados-e-suporte-a-plugins-para-páginas-do-github)
    - [Visualizando Metadados YAML em seus Documentos](#visualizando-metadados-yaml-em-seus-documentos)
    - [Renderizando Dados Tabulados](#renderizando-dados-tabulados)
    - [Renderizando PDF](#renderizando-pdf)
    - [Revertendo um Pull Request](#revertendo-um-pull-request)
    - [Diferenciações](#diffs)
      - [Rendered Prose Diffs](#rendered-prose-diffs)
      - [Mapas de Diferenciação](#mapas-de-diferenciação)
      - [Expandindo o Contexto em Diferenciações](#expandindo-o-contexto-em-diferenciações)
      - [Diferenciação ou Patch de Pull Request](#diferenciação-ou-patch-de-pull-request)
      - [Renderizando e Diferenciando Imagens](#renderizando-e-diferenciando-imagens)
    - [Hub](#hub)
    - [Regras para Contribuição](#regras-de-contribuição)
      - [Arquivo CONTRIBUTING](#arquivo-contributing)
      - [Arquivo ISSUE_TEMPLATE](#arquivo-issue_template)
      - [Arquivo PULL_REQUEST_TEMPLATE](#arquivo-pull_request_template)
    - [Octicons](#octicons)
    - [Pacote de Desenvolvedor Estudante do GitHub](#pacote-de-desenvolvedor-estudante-do-github)
    - [Recursos do GitHub](#recursos-do-github)
      - [GitHub Talks](#github-talks)
    - [Chaves SSH](#chaves-ssh)
    - [Templates de Repositório](#templates-de-repositório)
  - [Git](#git)
    - [Removendo Todos os Arquivos Excluídos da Árvore principal](#removendo-todos-os-arquivos-excluídos-da-árvore-principal)
    - [Branch Anterior](#branch-anterior)
    - [Removendo espaços](#removendo-espaços)
    - [Verificando Pull Requests](#verificando-pull-requests)
    - [Commits vazios](#commits-vazios)
    - [Git Status Estilizado](#git-status-estilizado)
    - [Git Log Estilizado](#git-log-estilizado)
    - [Git Query](#git-query)
    - [Git Grep](#git-grep)
    - [Branches Mescladas](#branches-mescladas)
    - [Fixup e Autosquash](#fixup-e-autosquash)
    - [Servidor web para Navegação de Repositórios Locais](#servidor-web-para-navegação-de-repositórios-locais)
    - [Configurações do Git](#configurações-do-git)
      - [Apelidos](#apelidos)
      - [Correções Automáticas](#correções-automáticas)
      - [Cor](#cor)
    - [Recursos do Git](#recursos-do-git)
      - [Livros sobre Git](#livros-sobre-git)
      - [Vídeos sobre Git](#vídeos-sobre-git)
      - [Artigos sobre Git](#artigos-sobre-git)
