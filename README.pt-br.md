...
## Índice
  - [GitHub](#github)
    - [Ignorar espaços em branco](#ignore-whitespace)
    - [Ajustar espaçamento de tabelas](#adjust-tab-space)
    - [Histório de commits por autor](#commit-history-by-author)
    - [Clonando um repositório](#cloning-a-repository)
    - [Branch](#branch)
      - [Compare todas as branches com outra branch](#compare-all-branches-to-another-branch)
      - [Comparando Branches](#comparing-branches)
      - [Comparando Branches através de Repositórios Bifurcados](#compare-branches-across-forked-repositories)
    - [Gists](#gists)
    - [Git.io](#gitio)
    - [Atalhos de teclado](#keyboard-shortcuts)
    - [Destaque para Linha em Repositórios](#line-highlighting-in-repositories)
    - [Fechando Issues pelas Mensagens de Commit](#closing-issues-via-commit-messages)
    - [Referências cruzadas em Issues](#cross-link-issues)
    - [Bloqueando Conversas](#locking-conversations)
    - [CI Status em Pull Requests](#ci-status-on-pull-requests)
    - [Filtros](#filters)
    - [Sintaxe de destaque em Arquivos Markdown](#syntax-highlighting-in-markdown-files)
    - [Emojis](#emojis)
    - [Imagens/GIFs](#imagesgifs)
      - [Imagens embutidas na Wiki do GitHub](#embedding-images-in-github-wiki)
    - [Citações Rápidas](#quick-quoting)
    - [Colando imagens da Área de Transferência para comentários](#pasting-clipboard-image-to-comments)
    - [Licensa Rápida](#quick-licensing)
    - [Listas de tarefas](#task-lists)
      - [Lstas de Tarefas em Documentos Markdown](#task-lists-in-markdown-documents)
    - [Links Relativos](#relative-links)
    - [Metadados e Suporte a Plugins para Páginas do GitHub](#metadata-and-plugin-support-for-github-pages)
    - [Visualizando Metadados YAML em seus Documentos](#viewing-yaml-metadata-in-your-documents)
    - [Renderizando Dados Tabulados](#rendering-tabular-data)
    - [Renderizando PDF](#rendering-pdf)
    - [Revertendo um Pull Request](#revert-a-pull-request)
    - [Diferenciações](#diffs)
      - [Rendered Prose Diffs](#rendered-prose-diffs)
      - [Mapas de Diferenciação](#diffable-maps)
      - [Expandindo o Contexto em Diferenciações](#expanding-context-in-diffs)
      - [Diferenciação ou Patch de Pull Request](#diff-or-patch-of-pull-request)
      - [Renderizando e Diferenciando Imagens](#rendering-and-diffing-images)
    - [Hub](#hub)
    - [Regras para Contribuição](#contribution-guidelines)
      - [Arquivo CONTRIBUTING](#contributing-file)
      - [Arquivo ISSUE_TEMPLATE](#issue_template-file)
      - [Arquivo PULL_REQUEST_TEMPLATE](#pull_request_template-file)
    - [Octicons](#octicons)
    - [Pacote de Desenvolvedor Estudante do GitHub](#github-student-developer-pack)
    - [Recursos do GitHub](#github-resources)
      - [GitHub Talks](#github-talks)
    - [Chaves SSH](#ssh-keys)
    - [Templates de Repositório](#repository-templates)
  - [Git](#git)
    - [Removendo Todos os Arquivos Excluídos da Árvore principal](#remove-all-deleted-files-from-the-working-tree)
    - [Branch Anterior](#previous-branch)
    - [Removendo espaços](#stripspace)
    - [Verificando Pull Requests](#checking-out-pull-requests)
    - [Commits vazios](#empty-commits)
    - [Git Status Estilizado](#styled-git-status)
    - [Git Log Estilizado](#styled-git-log)
    - [Git Query](#git-query)
    - [Git Grep](#git-grep)
    - [Branches Mescladas](#merged-branches)
    - [Fixup e Autosquash](#fixup-and-autosquash)
    - [Servidor web para Navegação de Repositórios Locais](#web-server-for-browsing-local-repositories)
    - [Configurações do Git](#git-configurations)
      - [Apelidos](#aliases)
      - [Correções Automáticas](#auto-correct)
      - [Cor](#color)
    - [Recursos do Git](#git-resources)
      - [Livros do Git](#git-books)
      - [Vídeos do Git](#git-videos)
      - [Artigos do Git](#git-articles)
